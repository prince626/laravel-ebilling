...
<body>
    <div class="container-fluid pt-5">
        <div class="row justify-content-center">
            <div class="col-sm-4  ">
                <h1 class="pb-4">Signup Page</h1>
                <form action="/api/register" method="POST" class="php-email-form">
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="companyName" class="form-control" id="BussinessName" aria-describedby="emailHelp">
                    </div>
                    <div class="mb-3">
                    ...
                    .then(data => {
                        ...
                        if (data.success) {
                            ...
                            if (data.status == 'success') {
                                // window.location.href = `http://localhost:8000/api/getfirstdata`;
                                setTimeout(function() {
                                    window.location.href = 'http://localhost:8000/api/getfirstdata';
                                }, 1000);
                            }
