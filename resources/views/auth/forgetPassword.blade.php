...
<body>
    <div class="container-fluid pt-5">
        <div class="row justify-content-center">
            <div class="col-sm-4 forget-form p-3">
                <h1 class="pb-4 text-center">Forget Password</h1>
                <form action="/api/forget_password" method="POST" class="php-email-form">
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">Phone No<span class="text-danger">*</span></label>
                        <input type="text" name="phone" value="" class="form-control" id="phone" aria-describedby="emailHelp">
                    </div>
                    ...
                    .then(data => {
                        ...
                        if (data.success) {
                            ...
                            if (data.status == 'success') {
                                ...
                                window.location.href = `http://localhost:8000/verify_forget/${useremail}`;
                            }
                            // else {
                            //     thisForm.reset();
                            //     location.reload();
