                    ...
                    <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                        ...
                        <div class="social-links mt-2">
                            {{-- <a class="twitter" data-bs-target="#profile-edit"><i class="bi bi-pencil-square"></i>
                                <button class=" btn nav-link" data-bs-target="#profile-change-password"><i class="bi bi-key"></i></button> --}}
                            {{-- <ul class="nav nav-tabs" id="myTabs">
                                    <li class="nav-item" style="display: none;">
                                        <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#profile-overview"></button>
                                    </li>
                                    <li class="nav-item">
                                        <button class="nav-link" data-bs-toggle="tab" data-bs-target="#profile-edit"><i class="bi bi-gear-fill"></i></button>
                                    </li>
                                    <li class="nav-item">
                                        <button class="nav-link" data-bs-toggle="tab" data-bs-target="#profile-change-password"><i class="bi bi-key"></i> </button>
                                    </li>
                                </ul> --}}
                        </div>
                    </div>
                        ...
                        <div class="tab-content pt-2">
                            ...
                            <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-9 col-md-8">{{ $user->category }}</div>
                                </div>
                            ...
                            <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                                ...
                                <!-- Profile Edit Form -->
                                <form action="/api/user/update/{{$user->user_id}}" method="POST" class="php-email-form">
                                    @csrf
                                    {{-- <div class="row mb-3">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <input type="text" name="name" required value={{ $user->name }} class="form-control" id="fullName">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        <label for="Job" class="col-md-4 col-lg-3 col-form-label">Company Name</label>
                                        <div class="col-md-8 col-lg-9">
                                            <input type="text" class="form-control" id="Job" required name="companyName" value="{{ $user->companyName }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <input type=" text" class="form-control" id="Country" required name="city" value="{{ $user->city }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <input name="address" type="text" class="form-control" required id="Address" value="{{ $user->address }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <input name="email" type="email" class="form-control" required id="Email" value="{{ $user->email }}">
                                        </div>
                                    </div>

                                    <div class="row mb-3">
                                        <label for="Twitter" class="col-md-4 col-lg-3 col-form-label">Phone No</label>
                                        <div class="col-md-8 col-lg-9">
                                            <input type="number" class="form-control" id="Twitter" required name="phone" maxlength="10" value="{{ $user->phone }}">
                                        </div>
                                    </div>
                            ...
                            <div class="tab-pane fade pt-3 php-email-form" id="profile-change-password">
                                <!-- Change Password Form -->
                                <form action="/api/user/change_password" method="POST" class="php-email-form">
                                    @csrf
