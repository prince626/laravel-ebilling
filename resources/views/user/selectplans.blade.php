...
<style>
     ...
     select option:hover {
    background-color: black !important; /* Change this to the desired hover color */
}
</style>
<main id="main" class="main">
    ...
    <div class="container-fluid pt-3">
        ...
        <h1 class="text-center">Select plan which suits you best ?</h1>
        <p class="text-center">There different plan for users pick the right on for you.</p>
        <form action='/api/user/subs/{{ $user->token }}' method="POST" class="php-email-form">
            @csrf
    ...
    <div class="row mt-4 bg-white  mx-1 p-3">
        <div class="col-md-2">
        ...
        <div class="col-md-3 text-end">
            <p class="">Add Some Features  </p>
        </div>

    </div>
    <div class="chooseplan bg-white mt-4 mx-1  p-3">
        ...
        <div class=" afteraddons" style="display: none;" >
            ...
            <p class=""><span id="addonsdescription1" class="m-2"></span ><span id="addonsdescription2" class="m-2"></span></p>
                ...
                <div class="col-md-2">
                    <p class="btn btn-warning text-end float-end text-light" id="addonsAmount"></p>
                </div>
            </div> 
            <hr>
        ...
        <div class="afterselectedAmount" style="" >
            ...
            <div class="row">
                <div class="col-md-9 mt-2">
                  <p >  <a href="#kitaction" class="text-warning">Have A kit code ?</a></p>
                </div>
                <div class="col-md-3">
    ...
    <div class="mt-2 mx-1 bg-white p-3" id="kitaction" style="" >
        {{-- <h4>Selected Payment</h4> --}}
        <strong>Activate by kit</strong>
        <div class="row">
            <div class="col-md-9 mt-2">
                <p class="">Scratch your key kit and enter your key code</p>
            </div>
            <div class="col-md-3">
