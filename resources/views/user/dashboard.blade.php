            ...
            <section class="section2  dashboard">
                ...
                <div class="row">
                    ...
                    <div class="col-xxl-4 col-md-4">
                        <a href="/api/user/subscription" class="card info-card sales-card">
                    ...
                    <div class="col-xxl-4 col-md-4">
                        <a href="/api/user/profile" class="card info-card sales-card">
                            <div class="card-body">
                                <h5 class="card-title">Customize Profile <span></span></h5>
                                <div class="d-flex align-items-center">
                                    <div class="card-icon rounded-circle d-flex align-items-center justify-content-center">
                    ...
                    <div class="col-xxl-4 col-md-4">
                        <a href="/api/user/recharge_invoices" class="card info-card sales-card">



                            <div class="card-body">
                                <h5 class="card-title">View Invoices<span> </span></h5>
                        ...
                        <div class="card mb-3" style="border-radius: .5rem;">
                            <div class="row g-0">
                                <div class="col-md-4 gradient-custom text-center" style="border-top-left-radius: .5rem; border-bottom-left-radius: .5rem;">
                                    ...
                                    <i class="bi bi-person-circle mt-5 mb-1 text-info" style="font-size: 100px;"></i>
                ...
                <div class="card-body">
                    ...
                    <div class="activity">
                        ...
                        <div class="activity-item d-flex">
                            ...
                            <i class="bi bi-circle-fill activity-badge text-@if($activity->action_type == 'login_success')success @elseif($activity->action_type == 'password_updated')primary @elseif($activity->action_type == 'receipt_read')danger @else secondary @endif align-self-start"></i>
